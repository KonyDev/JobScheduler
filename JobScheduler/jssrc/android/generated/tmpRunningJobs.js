function initializetmpRunningJobs() {
    ...
    flxTmpRunningjobs.add(
    lblRunningJobName, lblRunningJobDesc, lblJobId);
    ...
    FlexContainer02f5da4f4604247.add(
    imgDelete);
    flxTmpRunningjobs1.add(
    flxTmpRunningjobs, FlexContainer02f5da4f4604247);
}