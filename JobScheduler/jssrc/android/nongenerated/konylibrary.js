...
kony.os.addToDate = function(d1, frmt, unt, cnt) {
    ...
    if (dateObj) {
        ...
        if (kony.os.isLeapYear([d1, fmt]) && dateObj.getMonth() >= 1 && (unit == "years" || (unit == "months" && (count == -12 || count == 12)))) dateObj.setDate(dateObj.getDategetDate() - 1);
