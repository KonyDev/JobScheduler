function addWidgetsfrmScheduler() {
    ...
    flxConstraints.add(lblConst, Label0b5c3143f396043, listBoxConstraintsVaule1, Label0f654a579fdb043);
    ...
    flxConnectivity.add(lblConnectivity, CopyLabel040057c46e74d49, rdbConnectivity, CopyLabel029e9a40d357e49);
    ...
    flxTimeDeadline.add(lblDeadLine, CopyLabel09d04cbc041324e, txtDeadline, Label01b856ca7ea434e);
    ...
    flxCharging.add(lblCharging, lblColon, chbxCharging, lblLine);
    ...
    flxIdealMode.add(lblIdealMode, CopyLabel032b5978ab4284d, chbxIdle, CopyLabel03af4c062225644);
    ...
    flxTimeDelay.add(lblTimeDelay, CopyLabel059afc5a09b7142, txtTimeDelay, CopyLabel055f0e015db574d);
    FlexContainer07800686bed244d.add(flxConstraints, flxConnectivity, flxTimeDeadline, flxCharging, flxIdealMode, flxTimeDelay);
    ...
    flxScheduleCancleBtn.add(btnScheduleJob, btnCancel);
    tabSchedule.add(FlexContainer07800686bed244d, flxScheduleCancleBtn);
    ...
    flxNoRunningJobs.add(Label080a5157b5ebe4c, Label0c9db645ea2d04f, Label050cd1ef3060d4f);
    ...
    flxRunningJobs.add(segRunningJobs);
    tabJobsRunning.add(flxNoRunningJobs, flxRunningJobs);
    tabPaneScheduler.addTab("tabJobsRunning", "Running Jobs", null, tabJobsRunning, null);
    frmScheduler.add(tabPaneScheduler);
};
